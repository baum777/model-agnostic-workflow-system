...
| 3 | derived | Summaries, baselines, examples, and templates that explain or demonstrate current practice. Includes non-canonical governance-adjacent decision records, gap analyses, and contract-extension proposals that explain or propose without redefining canonical rules. | `docs/overview.md`, `docs/eval-baseline.md`, `templates/codex-workflow/*`, `examples/codex-workflow/*`, `docs/pi-agent-kit-adapter-core-anchor-decision.md`, `docs/computer-use-policy.md`, `docs/skill-contract-gap-analysis.md`, `docs/human-approval-tier-extension.md`, `docs/permission-boundary-approval-extension-proposal.md`, `docs/pi-provider-adapter-specification.md`, `docs/skill-schema-extension-proposal.md` |
...
- Canonical docs: `docs/authority-matrix.md`, `docs/architecture.md`, `docs/compatibility.md`, `docs/governance/source-hierarchy.md`, `docs/lock-model.md`, `docs/mcp/policy.md`, `docs/repo-overlay-contract.md`, `docs/secret-handling.md`, `docs/security/extension-install-safety-policy.md`, `docs/shared-with-local-inputs.md`, `docs/repo-intake-skill-contract.md`, `docs/runtime-policy-skill-contract.md`, `docs/portability.md`, `docs/provider-capability-matrix.md`, `docs/ui-ux-composition-branch.md`
...
- Derived governance-adjacent decision/proposal docs (non-canonical, do not redefine policy or contracts): `docs/pi-agent-kit-adapter-core-anchor-decision.md`, `docs/computer-use-policy.md`, `docs/skill-contract-gap-analysis.md`, `docs/human-approval-tier-extension.md`, `docs/permission-boundary-approval-extension-proposal.md`, `docs/pi-provider-adapter-specification.md`, `docs/skill-schema-extension-proposal.md`
