...
| 3 | derived | Summaries, baselines, examples, and templates that explain or demonstrate current practice. Includes non-canonical governance-adjacent decision records, gap analyses, and contract-extension proposals that explain or propose without redefining canonical rules. | `docs/overview.md`, `docs/eval-baseline.md`, `templates/codex-workflow/*`, `examples/codex-workflow/*`, `docs/pi-agent-kit-adapter-core-anchor-decision.md`, `docs/computer-use-policy.md`, `docs/skill-contract-gap-analysis.md`, `docs/human-approval-tier-extension.md`, `docs/permission-boundary-approval-extension-proposal.md` |
...
- Derived governance-adjacent decision/proposal docs (non-canonical, do not redefine policy or contracts): `docs/pi-agent-kit-adapter-core-anchor-decision.md`, `docs/computer-use-policy.md`, `docs/skill-contract-gap-analysis.md`, `docs/human-approval-tier-extension.md`, `docs/permission-boundary-approval-extension-proposal.md`
